...
import { LiveSearch } from "../productos/LiveSearch";
...
export function Header() {
  ...
  return (
    <motion.header
      ...
      className="sticky top-0 z-50 w-full border-b border-brand-primary/10 bg-white/95 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/60"
    >
      <div className="flex h-16 items-center gap-2 pl-12 pr-2">
        <Logo />
      ...
      <AnimatePresence>
        {searchOpen && (
          <motion.div
            ...
            className="border-t border-brand-primary/10 px-2 py-3 md:hidden overflow-hidden"
          >
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            animate={{ height: "auto", opacity: 1 }}
            exit={{ height: 0, opacity: 0 }}
            className="border-t border-brand-primary/10 md:hidden overflow-hidden"
          >
